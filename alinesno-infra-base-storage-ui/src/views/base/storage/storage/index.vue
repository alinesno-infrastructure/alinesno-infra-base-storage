      ...
      <el-row :gutter="20">
         ...
         <el-col :span="20" :xs="24">
            ...
            <el-table v-loading="loading" :data="StorageList" @selection-change="handleSelectionChange">
               ...
               <el-table-column label="Storage配置" align="center" width="130" key="promptContent" prop="promptContent" v-if="columns[2].visible" :show-overflow-tooltip="true">
                  <template #default="scope">
                     <el-button type="primary" text bg icon="Paperclip" @click="configStorage(scope.row)">配置</el-button>
                  </template>
               </el-table-column>
...
function configStorage(row){
   ...
   if(row.promptContent){
      currentStorageContent.value = JSON.parse(row.promptContent);
   }
}
