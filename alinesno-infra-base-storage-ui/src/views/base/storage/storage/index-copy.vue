      ...
      <el-row :gutter="20">
         ...
         <el-col :span="20" :xs="24">
            ...
            <el-table v-loading="loading" :data="StorageList" @selection-change="handleSelectionChange">
               ...
               <el-table-column label="文件类型" align="center" width="130" key="platform" prop="platform" v-if="columns[2].visible" :show-overflow-tooltip="true">
                  <template #default="scope">
                     <el-button type="primary" text bg icon="Paperclip" @click="configStorage(scope.row)">{{ scope.row.platform }}</el-button>
                  </template>
               </el-table-column>
