...
import com.alinesno.infra.base.fileshow.core.filter.BaseUrlFilter;
import com.alinesno.infra.base.fileshow.core.model.FileAttribute;
import com.alinesno.infra.base.fileshow.core.model.FileType;
import com.alinesno.infra.base.fileshow.core.utils.EncodingDetects;
import com.alinesno.infra.base.fileshow.core.utils.KkFileUtils;
import com.alinesno.infra.base.fileshow.core.utils.UrlEncoderUtils;
...
public class FileHandlerService implements InitializingBean {
    ...
    public List<String> pdf2jpg(String fileNameFilePath, String pdfFilePath, String pdfName, FileAttribute fileAttribute) throws Exception {
        boolean forceUpdatedCache = fileAttribute.getForceUpdatedCache() ; // .forceUpdatedCache();
        boolean usePasswordCache = fileAttribute.isUsePasswordCache() ; // .getUsePasswordCache();
